...
>>>>>>> 6968996a0fcca1173c089210358c0dd47122d77e
...
function formatRecommendation(recommendation) {
  if (typeof recommendation === 'object') {
    if (recommendation.causes && recommendation.actions) {
      ...
      return `
        <div>
          <h4 class="font-semibold text-black">Causes:</h4>
          <ul class="list-disc pl-5 text-black">${causes}</ul>
          <h4 class="font-semibold mt-2 text-black">Actions:</h4>
          <ul class="list-disc pl-5 text-black">${actions}</ul>
        </div>
      `;
    }
